...
public class Nav1Controller {
	...
	public String contribute(HttpServletRequest request){
		request.setAttribute("sendTitle", "投稿");
	...
	public String sponsor(HttpServletRequest request){
		request.getSession().setAttribute("title", "sponsor.html");
		request.getSession().setAttribute("contentTitle", "sponsor.html");
		Map<String, Object>map =new HashMap<String, Object>();
		map.put("commentPage", "sponsor.html");
		...
		request.setAttribute("sendTitle", "赞助");
		return "index";
	}
	...
	public String list(HttpServletRequest request){
		request.getSession().setAttribute("title", "leavingMessage.html");
		request.getSession().setAttribute("contentTitle", "leavingMessage.html");
		Map<String, Object>map =new HashMap<String, Object>();
		map.put("commentPage", "leavingMessage.html");
		List<LeavingMessage>leavingMessagesList = leavingMessageService.find(map);
		request.setAttribute("leavingMessagesList", leavingMessagesList);
		request.setAttribute("mainPage", "leavingMessage/leavingMessage.jsp");
		request.setAttribute("sendTitle", "留言");
		return "index";
	}
